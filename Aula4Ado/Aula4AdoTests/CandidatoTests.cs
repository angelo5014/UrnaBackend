...
namespace Aula4AdoTests
{
    ...
    {
        Candidato candidatoDeTeste = new Candidato("Júlio César", "Júlio", new DateTime(1992, 12, 31), "000", 2, 3, 4, false)
        {
            IdCandidato = 1
        };
        Candidato candidatoDeTesteIgual = new Candidato("Júlio César", "Júlio", new DateTime(1992, 12, 31), "000", 2, 3, 4, false)
        {
            IdCandidato = 1
        };
        ...
        public void CandidatoToString()
        {
            string esperado = string.Format("{1} {2}, {3} {4}, {5} {6},{0}{7} {8:dd/MM/yyyy}, {9} {10}, {11} {12},{0}{13} {14}, {15} {16}, {17} {18}", "\r\n",
                ...
                "Numero:", "3", "Id do cargo:", "4", "Exibe:", "False");
